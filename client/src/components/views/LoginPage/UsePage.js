...
function UsePage(props) {
  ...
  return (
    <>
      ...
      <p style={{textAlign:'center'}}><strong>TÉRMINOS DE SERVICIO</strong></p>

      <p style={{fontWeight:'600', marginTop:'25px'}}>
      INFORMACIÓN GENERAL
      </p>
      <p>
      Este sitio web es operado por GlamStudio MakeUp. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a GlamStudio MakeUp. GlamStudio MakeUp ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
      </p>
      <p>
      ...
      <p>
      Por favor, lee estos Términos de Servicio cuidadosamente antes de acceder o utilizar nuestro sitio web. Al acceder o utilizar cualquier parte del sitio, estás aceptando los Términos de Servicio. Si no estás de acuerdo con todos los términos y condiciones de este acuerdo, entonces no deberías acceder a la página web o usar cualquiera de los servicios. Si en los Términos de Servicio son considerados una oferta, la aceptación está expresamente limitada a estos Términos de Servicio.
      </p>
      <p>
      ...
      <p>
      Ciertos productos o servicios pueden estar disponibles exclusivamente en línea a través del sitio web. Estos productos o servicios pueden tener cantidades limitadas y estar sujetas a devolución o cambio de acuerdo a nuestra <a href={'/politica-de-devoluciones'}>Política de Devoluciones</a> solamente.
      </p>
      <p>
      ...
      <p>
      Para más detalles, por favor revisa nuestra <a href={'/politica-de-devoluciones'}>Política de Devoluciones</a>.
      </p>
      <p style={{fontWeight:'600', marginTop:'25px'}}>
      ...
      <p>
        Los pagos se ejecutan mediante el servicio externo de Mercado Pago. Por favor revisa cuidadosamente estar en el sitio real de Mercado Pago antes de ingresar datos personales (https:///mercadopago.com.ar/).
      </p>
      <p style={{fontWeight:'600', marginTop:'25px'}}>
      ...
      <p>
      Tu presentación de información personal a través del sitio se rige por nuestra <a href={'/politica-de-privacidad'}>Política de Privacidad</a>.
      </p>
      <p style={{fontWeight:'600', marginTop:'25px'}}>
      ...
      <p>
      Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Senillosa 226, Ciudad Autónoma de Buenos Aires, CP1406, Argentina.
      </p>
      <p style={{fontWeight:'600', marginTop:'25px'}}>
      ...
      <p>
      Preguntas acerca de los Términos de Servicio deben ser enviadas por WhatsApp.
      </p>
      <br/>
      <br/>
      <br/>
