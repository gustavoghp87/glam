...
function Footer() {
    ...
    const renderFooter = () => {
        if (window.screen.width>767) {
            ...
            return (
                <div className="main-footer" style={{fontSize: '1.5rem', paddingTop: '20px', paddingBottom: '20px', backgroundColor: '#343a40', height: '250px'}}>
            ...
            return (
                <div className="main-footer" style={{fontSize: '1rem', paddingTop: '20px', paddingBottom: '20px', backgroundColor: '#343a40', height: '280px'}}>
