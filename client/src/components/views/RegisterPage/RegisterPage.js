        ...
        return (
          <div className="app" style={estiloApp}>
            ...
            <div style={estilo2}>
              ...
              <br/>
              <h6>Si creas una cuenta pero después ingresas por Facebook o Google, los métodos de ingreso se unificarán (excepto que uses distintos emails).</h6>
              <br/>
              <h6>Si eliges una contraseña demasiado sencilla, tu navegador puede darte un mensaje de advertencia de "tu contraseña quedó expuesta"; se recomienda al menos 10 caracteres combinando letras y números.</h6>
              <br/>
            </div>
